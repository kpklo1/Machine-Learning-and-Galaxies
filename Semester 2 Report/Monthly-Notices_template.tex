...
The result of this is an object which directs further functions to the positions and sizes of these sources. This object is used in the \lstinline{source_properties} function and is called \lstinline{segm} in the code. 
\subsection{FNN}
